...
components.fonts = {
    selector: 'html',
    styles: 'https://fonts.googleapis.com/css2?family=Raleway&display=swap'
};
...
components.accordion = {
    ...
    script: [
        ...
        './current-device/current-device.min.js',
        './multiswitch/multiswitch.min.js'
    ],
    init: function(nodes) {
...
components.animate = {
    ...
    script: './current-device/current-device.min.js',
    init: function(nodes) {
...
components.countdown = {
    ...
    script: [
        './progress-circle/progress-circle.min.js',
...
// 	script: [
// 		'./jquery/jquery.min.js',
// 		'./blotter/blotter.min.js',
// 		'./blotter/liquidDistortMaterial.js'
// 	],
// 	init: function () {
...
components.multiswitch = {
    ...
    styles: './multiswitch/multiswitch.css',
    script: [
        './current-device/current-device.min.js',
        './multiswitch/multiswitch.min.js'
    ],
...
components.owl = {
    ...
    styles: './owl-carousel/owl.carousel.css',
    script: [
        './jquery/jquery.min.js',
...
components.rdMailform = {
    ...
    styles: [
        './rd-mailform/rd-mailform.css',
        './font-awesome/font-awesome.css',
        './mdi/mdi.css'
    ],
    script: [
        './jquery/jquery.min.js',
        './rd-mailform/rd-mailform.min.js',
    ],
    init: function(nodes) {
        let i, j, k,
...
components.rdNavbar = {
    selector: '.rd-navbar',
    styles: './rd-navbar/rd-navbar.css',
    script: [
        './jquery/jquery.min.js',
        './util/util.min.js',
        './current-device/current-device.min.js',
        './rd-navbar/rd-navbar.min.js'
    ],
...
components.swiper = {
    ...
    script: [
        ...
        './swiper/swiper-progress-circle.min.js',
        './util/util.min.js'
    ],
    init: function(nodes) {
        nodes.forEach(function(node) {
...
components.regula = {
    ...
    styles: './regula/regula.css',
    script: [
        './jquery/jquery.min.js',
        './regula/regula.min.js'
    ],
    init: function(nodes) {
        let elements = $(nodes);
...
components.preloader = {
    selector: '.preloader',
    styles: './preloader/preloader.css'
};

components.toTop = {
    selector: 'html',
    styles: './to-top/to-top.css',
